...
public enum AllStudentDetailsMappers {
    ...
    STUDENT_NOT_FOUND_WITH_GIVEN_PERCENTAGE("STUDENT NOT FOUND WITH GIVEN PERCENTAGE", "SNF-2"),
    STUDENT_NOT_FOUND_WITH_GIVEN_MARKS_AND_SUBJECT("STUDENT NOT FOUND WITH GIVEN SUBJECT AND MARKS", "SNF-3"),
